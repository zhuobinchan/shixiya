...
<div class="login-box">
	<h1>合作企业登录</h1>
	<form method="post" action="clogin_login.action" onsubmit="return checkForm()">
		<table>
			<tr class="name">
				<td><label>账 号：</label></td>
				<td><input type="text" id="name" name="email" tabindex="1" autocomplete="off" /><p style="color: red">${falsename }</p></td>
			</tr>
			<tr class="password">
