	...
	<div id="sidebar">
		<ul>
			...
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>实习岗位管理</span> <span class="label">1</span></a>
				<ul>
					
					<li id="addCourseLi"><a href="${pageContext.request.contextPath}/bussinessReInfo_showRecruitmentInfo.action"><i
						class="icon icon-home"></i>发布实习生招聘</a></li>
					<li id="addCourseLi"><a href="${pageContext.request.contextPath}/bussinessSubmit_showRecruitResumeSubmit.action"><i
						class="icon icon-home"></i>应聘管理</a></li>
